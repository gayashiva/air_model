...
if __name__ == "__main__":
    ...
    styles=['.', '*']
    legend_elements = [Line2D([0], [0], color=mypal[0], lw=4, label='Guttannen 2022'),
                        Line2D([0], [0], color=mypal[1], lw=4, label='Guttannen 2021'),
                        Line2D([0], [0], color=mypal[2], lw=4, label='Gangles 2021'),
                       Line2D([0], [0], marker='.', color='w', label='Manual',
                              markerfacecolor='k', markersize=15),
                       Line2D([0], [0], marker='*', color='w', label='Automatic',
                              markerfacecolor='k', markersize=15),
                       ]
