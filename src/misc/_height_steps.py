...
if __name__ == "__main__":
    dis= 13
    print(get_projectile(h_f=2.75, dia=0.006, dis=dis, theta_f=60))
    dis= get_height_steps(dis, dia_f=0.006)
    print(get_projectile(h_f=3.75, dia=0.006, dis=dis, theta_f=60))
    dis= get_height_steps(dis, dia_f=0.006)
    print(get_projectile(h_f=4.75, dia=0.006, dis=dis, theta_f=60))
    dis= get_height_steps(dis, dia_f=0.006)
    print(get_projectile(h_f=5.75, dia=0.006, dis=dis, theta_f=60))
    # f_heights = [
