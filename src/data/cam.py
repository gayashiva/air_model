...
df_in4["Label"] = '2020-' + df_in4["Label"].str[2:4] + "-" + df_in4["Label"].str[4:6] + " " + df_in4["Label"].str[6:8]
...
df_in4['Radius'] = df_in3['Length']/(183.85 * 2)
...
ax1t = ax1.twinx()
ax1t.plot(dfd2.When, dfd2.Radius, 'o-', color="b", alpha=0.5, linewidth=0.5)
