...
fig = plt.figure()
cmap = plt.cm.rainbow
norm = matplotlib.colors.Normalize(vmin=problem['bounds'][0][0], vmax=problem['bounds'][0][1])
...
dfo=dfo.round(4)
filename2 = os.path.join(output_folder, site + "_simulations__"+ str(problem['names'][0]) + '.csv')
